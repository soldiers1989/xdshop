...
public class ContentUtils {
	static String chnStrReg = "[\u4e00-\u9fa5]+|，|“|”|。";
	public static int getTotalByte(String content){
		int totalByte = 0;
	 ...
	 * @return
	 */
	public static int getCurrRow(String content,int currIndex,int byteNumOneRow,LinkedList<String> tableList){
	...
	public static LinkedList<String> getTableList(String content,int currIndex,int byteNumOneRow,LinkedList<String> tableList){
		currIndex = ContentUtils.getCurrRow(content,currIndex, byteNumOneRow,tableList);
	...
	public static void main(String[] args) {
		...
		int currIndex = 0;
		ContentUtils contentTest = new ContentUtils();
