...
public class ImageTest2 {
	...
	public BufferedImage createContentImage(String content,int width,int height,int fontSize,Color color) throws IOException{
//		int width = 800;
//		int height =1000;
...
//		BufferedImage qrImage = ImageIO.read(new File("G:\\xdshop\\AppID相关\\二维码-测试公众号-接口获取.jpg"));
		...
		BufferedImage nickNameImage = new ImageTest2().createContentImage(nickName, 400, 40, 20);
		...
		*/
		...
		BufferedImage nickNameImage = new ImageTest2().createContentImage(ghName, 400, 40, 30,Color.black);
		int nickNameImageWidth =nickNameImage.getWidth();
		int nickNameHeight =nickNameImage.getHeight();
		...
		BufferedImage pressImage = new ImageTest2().createContentImage(pressTips, 400, 40, 20,Color.red);
		...
		BufferedImage operTipsImage = new ImageTest2().createContentImage(operTips, 600, 100, 40,Color.red);
		...
		BufferedImage joinMeImage = new ImageTest2().createContentImage(joinMe, 600, 60, 40,Color.red);
		...
		//输出合成图片
		ImageIO.write(bgImage, "jpg", new File("d:\\背景合成二维码-首次分享.jpg"));
